...
const { totalCalificaciones, cantidadCalificaciones } = this.#asignaturas.reduce(
    (acc, asignatura) => {
        if (asignatura.calificaciones?.length) {
    ...
    { totalCalificaciones: 0, cantidadCalificaciones: 0 }
);
